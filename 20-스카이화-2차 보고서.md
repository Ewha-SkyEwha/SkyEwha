...
| 이름 | 역할 | 담당 업무 |
| --- | --- | --- |
| 윤지운 | BE/AI | - 해시태그 추천 사용자 선호도 집계
- Docker 최적화 및 AWS 서버 운영 관리
- 서비스 초기 테스트 |
| 유화경 | BE/AI | - 영상 추천 알고리즘 개선
- 피드백 AI 도입 및 형식 개선 
- AWS 서버 마이그레이션 및 운영 관리 |
| 김하람 | FE | - API 연동
- 디자인 점검 및 UI/UX 보완
- 기능 최종 점검 |
...
![스크린샷 2025-11-09 230321.png](%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7_2025-11-09_230321.png)

### 3) UI 분석/설계 모델

1. 트렌드 대시보드(홈 화면)

![Screenshot_20251109_215708.png](Screenshot_20251109_215708.png)

 2. 키워드 검색 화면

![Screenshot_20251109_215741.png](Screenshot_20251109_215741.png)

1. 키워드 검색 결과

![Screenshot_20251110_001700.png](Screenshot_20251110_001700.png)
...
![Screenshot_20251109_220709.png](Screenshot_20251109_220709.png)

1. 입력매체 선택 화면

![Screenshot_20251109_221830.png](Screenshot_20251109_221830.png)

1. 피드백 보고서 화면

![Screenshot_20251110_144246.png](Screenshot_20251110_144246.png)

1. 마이페이지

![Screenshot_20251109_220609.png](Screenshot_20251109_220609.png)

**(1) 화면 흐름 (Flow)**

1. 사용자가 피드백 보고서 화면(3)에 접속한다.
2. 사용자는 피드백 보고서 제목을 작성하고, ‘다음’ 버튼을 누르면 사용자는 입력 매체를 선택하게 된다.(4)
    
    사용자는 제작한 여행 영상을 업로드하거나 영상에 쓰이는 자막 텍스트를 입력할 수 있다.
    
- 업로드 가능한 파일 형식은 MP4이며, 이에 대한 안내 문구가 화면에 표시된다.
1. 영상 업로드가 완료되면, 피드백 보고서 화면(5)이 제공된다. 
    - 업로드된 영상을 기반으로 해시태그, 제목, 참고 영상이 자동으로 추천된다.
2. 생성된 피드백 보고서 내역은 마이페이지(6)의 피드백 보고서 내역에서 확인할 수 있다.
